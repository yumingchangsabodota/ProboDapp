        ...
        <div className="row g-4 mx-auto" style={{ maxWidth: "700px" }}>
          <div className="col-md-6">
            <Link
              ...
              className="card h-100 text-decoration-none border-primary-subtle shadow-sm hover-shadow"
          ...
          <div className="col-md-6">
            <Link
              ...
              className="card h-100 text-decoration-none border-success-subtle shadow-sm hover-shadow"
              style={{ transition: "all 0.2s" }}
            >
              <div className="card-body p-4">
